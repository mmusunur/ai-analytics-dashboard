...
export default function Systemintegrityverification() {
  return (
    <div className="systemintegrityverification-card card" style={{ marginTop: '20px' }}>
      <h3 style={{ fontSize: '18px', fontWeight: 600, color: 'var(--text-primary)', marginBottom: '12px' }}>
        ⚡ System_Integrity_Verification
      </h3>
      <p style={{ color: 'var(--text-secondary)', fontSize: '14px', marginBottom: '16px' }}>
        Task spec reference --- section_1_mandatory_tasks.md ---   Section 1 Mandatory Tasks & Autonomous...
      </p>
