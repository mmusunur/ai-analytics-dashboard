...
export default function TrainTheUploadedTheCsvFileAndShowTheAnalytics() {
  return (
    <div className="traintheuploadedthecsvfileandshowtheanalytics-card card" style={{ marginTop: '20px' }}>
      <h3 style={{ fontSize: '18px', fontWeight: 600, color: 'var(--text-primary)', marginBottom: '12px' }}>
        ⚡ Train the uploaded the csv file and show the analytics
      </h3>
      <p style={{ color: 'var(--text-secondary)', fontSize: '14px', marginBottom: '16px' }}>
        Train the uploaded the csv file and show the analytics Task spec reference --- section_1_mandator...
      </p>
